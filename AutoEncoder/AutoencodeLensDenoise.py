...
num_classes = 2
num_epoch = 400
learning_rate = 0.00001  # Warning: lr and decay vary across optimizers
decay_rate = 1.0
...
print (x_train_noisy.shape, x_val.shape)

ModelFit = autoencoder.fit(x_train_noisy, x_train, batch_size=batch_size, epochs= num_epoch, verbose=2, validation_data=(x_val_noisy, x_val))
