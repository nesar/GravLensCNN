...
def AutoModel_conv():
    ...
    # x = Dense(x._keras_shape[1:3], activation='relu')(encoded)
...
ModelFit = autoencoder.fit(x_train, x_train , batch_size=batch_size, epochs= num_epoch, verbose=2, validation_data=(x_val, x_val))
...
if SaveModel:
    ...
    autoencoder.save('ModelOutEncode/autoGenerate_' + fileOut + '.hdf5')
    encoder.save('ModelOutEncode/encodeGenerate_' + fileOut + '.hdf5')
    decoder.save('ModelOutEncode/decodeGenerate_' + fileOut + '.hdf5')
